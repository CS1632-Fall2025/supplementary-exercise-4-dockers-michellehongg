...
public class D3Test {
  ...
  public void tEST3CATALOG() {
    ...
    assertEquals(vars.get("cat").toString(), "https://cs1632.appspot.com/images/cat2.jpg");
  }
  @Test
  ...
  public void tEST9FEED() {
    ...
    }
    {
      ...
      wait.until(ExpectedConditions.textToBe(By.xpath("//*[@id=\'feedResult\' and text()=\'Nom, nom, nom.\']"), "Nom, nom, nom."));
    }
  }
  @Test
  ...
  public void dEFECT2FUNGREETACATWITHNAME() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=true\";");
    assertThat(driver.findElement(By.xpath("//div[@id=\'greeting\']/h4")).getText(), is("Mistoffelees is not here."));
  }
  @Test
  public void dEFECT3FUNFEED() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.textToBe(By.xpath("//*[@id=\'feedResult\' and text()=\'Cat fight!\']"), "Cat fight!"));
    }
  }
}
